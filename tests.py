      ...
      if (Rpi.isOpen()):
            ...
            if game_Playing:
                  ...
                  try:
                        ...
                        if (len(match_players1)+len(match_players2)==0) and (len(match_players1)+len(match_players3)==0) and (len(match_players2)+len(match_players3)==0):
                              draw_text("Para comenzar, debe escoger equipos",pygame.font.SysFont('Algerian',40),(0,0,0), 100, 300)
                              draw_text("Presionar \"T\" para volver al inicio",pygame.font.SysFont('Algerian',40),(0,0,0), 100, 500)
                        else:
                              screen.blit(imagen_Fondo, (0,0))
